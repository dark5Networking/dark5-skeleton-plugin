...
<Project ToolsVersion="15.0" xmlns="http://schemas.microsoft.com/developer/msbuild/2003">
  ...
  <ItemGroup>
    ...
    <Reference Include="Dark5.SDK.Core.net, Version=1.0.0.1, Culture=neutral, processorArchitecture=MSIL">
      <HintPath>..\packages\Dark5.SDK.Core.1.0.0.1\lib\net452\Dark5.SDK.Core.net.dll</HintPath>
      <Private>False</Private>
    </Reference>
    <Reference Include="Dark5.SDK.Server.net, Version=1.0.0, Culture=neutral, processorArchitecture=MSIL">
      <HintPath>..\packages\Dark5.SDK.Server.1.0.0\lib\net452\Dark5.SDK.Server.net.dll</HintPath>
      <Private>False</Private>
    </Reference>
