...
## Installation
Install the plugin into your server from the [Dark5 Hub](https://dark5networking.com/{{orgorig}}/{{projectorig}}): `d5pm install {{orgorig}}/{{projectorig}}`
